app.controller('header', function header($scope, $rootScope, user, snippets, scaladoc, throttle) {
	...
	$scope.teammates = new Array(
		...
		{name: 'Eric Comte Marois', linkedin: 'http://ca.linkedin.com/pub/éric-comte-marois/59/799/444', github: 'https://github.com/manbear', twitter: 'https://twitter.com/LordComte'},
